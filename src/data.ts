...
export const ChatBotType: SystemPurposeId[] = ['CON_high_8', 'EXT_high_3', 'EXT_low_0', 'EXT_low_9', 'OPE_high_1'];
export type SystemPurposeId = 'CON_high_8'|'EXT_high_3'|'EXT_low_0'|'EXT_low_9'|'OPE_high_1'|'Custom';
