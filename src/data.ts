...
export const ChatBotType: SystemPurposeId[] = ['AGR_low_0', 'AGR_low_3', 'AGR_low_9', 'CON_high_1', 'CON_high_2', 'CON_high_3', 'CON_high_4', 'CON_high_5', 'CON_high_6', 'CON_high_8', 'CON_high_9', 'CON_low_0', 'CON_low_2', 'CON_low_3', 'CON_low_6', 'CON_low_7', 'CON_low_9', 'EXT_high_1', 'EXT_high_2', 'EXT_high_3', 'EXT_high_4', 'EXT_high_6', 'EXT_high_7', 'EXT_high_9', 'EXT_low_0', 'EXT_low_1', 'EXT_low_2', 'EXT_low_3', 'EXT_low_4', 'EXT_low_6', 'EXT_low_7', 'EXT_low_8', 'EXT_low_9', 'NEU_high_0', 'NEU_high_1', 'NEU_high_2', 'NEU_high_3', 'NEU_high_4', 'NEU_high_5', 'NEU_high_7', 'NEU_high_9', 'NEU_low_0', 'NEU_low_1', 'NEU_low_3', 'NEU_low_4', 'NEU_low_5', 'NEU_low_6', 'NEU_low_8', 'OPE_high_1', 'OPE_high_3', 'OPE_high_4', 'OPE_high_5', 'OPE_high_6', 'OPE_high_9', 'OPE_low_0', 'OPE_low_2', 'OPE_low_3', 'OPE_low_4', 'OPE_low_5', 'OPE_low_7', 'OPE_low_8', 'OPE_low_9'];
export type SystemPurposeId = 'AGR_low_0'|'AGR_low_3'| 'AGR_low_9'|'CON_high_1'|'CON_high_2'|'CON_high_3'|'CON_high_4'|'CON_high_5'|'CON_high_6'|'CON_high_8'|'CON_high_9'|'CON_low_0'|'CON_low_2'|'CON_low_3'|'CON_low_6'|'CON_low_7'|'CON_low_9'|'EXT_high_1'|'EXT_high_2'|'EXT_high_3'|'EXT_high_4'|'EXT_high_6'|'EXT_high_7'|'EXT_high_9'|'EXT_low_0'|'EXT_low_1'|'EXT_low_2'|'EXT_low_3'|'EXT_low_4'|'EXT_low_6'|'EXT_low_7'|'EXT_low_8'|'EXT_low_9'|'NEU_high_0'|'NEU_high_1'|'NEU_high_2'|'NEU_high_3'|'NEU_high_4'|'NEU_high_5'|'NEU_high_7'|'NEU_high_9'|'NEU_low_0'|'NEU_low_1'|'NEU_low_3'|'NEU_low_4'|'NEU_low_5'|'NEU_low_6'|'NEU_low_8'|'OPE_high_1'|'OPE_high_3'|'OPE_high_4'|'OPE_high_5'|'OPE_high_6'|'OPE_high_9'|'OPE_low_0'|'OPE_low_2'|'OPE_low_3'|'OPE_low_4'|'OPE_low_5'|'OPE_low_7'|'OPE_low_8'|'OPE_low_9'|'Custom';
