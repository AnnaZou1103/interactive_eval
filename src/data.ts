...
export const ChatBotType: SystemPurposeId[] =['AGR_high_2', 'AGR_high_8', 'AGR_low_0', 'AGR_low_3', 'AGR_low_7', 'AGR_low_9', 'CON_high_0', 'CON_high_1', 'CON_high_2', 'CON_high_5', 'CON_high_6', 'CON_high_8', 'CON_high_9', 'CON_low_0', 'CON_low_1', 'CON_low_2', 'CON_low_3', 'CON_low_5', 'EXT_high_1', 'EXT_high_2', 'EXT_high_5', 'EXT_high_9', 'EXT_low_4', 'EXT_low_6', 'EXT_low_8', 'NEU_high_0', 'NEU_high_2', 'NEU_high_6', 'NEU_high_7', 'NEU_high_8', 'OPE_high_2', 'OPE_high_3', 'OPE_high_6', 'OPE_low_0', 'OPE_low_1', 'OPE_low_4', 'OPE_low_5', 'OPE_low_9']

export type SystemPurposeId = 'AGR_high_2'|'AGR_high_8'|'AGR_low_0'|'AGR_low_3'|'AGR_low_7'|'AGR_low_9'|'CON_high_0'|'CON_high_1'|'CON_high_2'|'CON_high_5'|'CON_high_6'|'CON_high_8'|'CON_high_9'|'CON_low_0'|'CON_low_1'|'CON_low_2'|'CON_low_3'|'CON_low_5'|'EXT_high_1'|'EXT_high_2'|'EXT_high_5'|'EXT_high_9'|'EXT_low_4'|'EXT_low_6'|'EXT_low_8'|'NEU_high_0'|'NEU_high_2'|'NEU_high_6'|'NEU_high_7'|'NEU_high_8'|'OPE_high_2'|'OPE_high_3'|'OPE_high_6'|'OPE_low_0'|'OPE_low_1'|'OPE_low_4'|'OPE_low_5'|'OPE_low_9'|'Custom'
