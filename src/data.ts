...
export const ChatBotType: SystemPurposeId[] =['AGR_high_2', 'AGR_low_3', 'CON_low_0', 'NEU_high_6']

export type SystemPurposeId = 'AGR_high_2'|'AGR_low_3'|'CON_low_0'|'NEU_high_6'|'Custom'
