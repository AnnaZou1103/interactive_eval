...
export const ChatBotType: SystemPurposeId[] =['AGR_high_9', 'AGR_low_3', 'AGR_low_8', 'CON_high_6', 'CON_high_7', 'CON_low_0', 'EXT_high_8', 'EXT_low_0', 'EXT_low_2', 'NEU_high_8', 'NEU_low_3', 'OPE_low_0', 'OPE_low_4', 'OPE_low_6']

export type SystemPurposeId = 'AGR_high_9'|'AGR_low_3'|'AGR_low_8'|'CON_high_6'|'CON_high_7'|'CON_low_0'|'EXT_high_8'|'EXT_low_0'|'EXT_low_2'|'NEU_high_8'|'NEU_low_3'|'OPE_low_0'|'OPE_low_4'|'OPE_low_6'|'Custom'
