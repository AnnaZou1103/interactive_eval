...
export const ChatBotType: SystemPurposeId[] =['AGR_high_9', 'AGR_low_3', 'AGR_low_6', 'AGR_low_7', 'AGR_low_8', 'CON_high_6', 'CON_high_7', 'CON_high_9', 'CON_low_0', 'CON_low_3', 'CON_low_5', 'EXT_high_0', 'EXT_high_2', 'EXT_high_8', 'EXT_low_0', 'EXT_low_2', 'NEU_high_8', 'NEU_low_0', 'NEU_low_1', 'NEU_low_3', 'OPE_high_9', 'OPE_low_0', 'OPE_low_4', 'OPE_low_6', 'OPE_low_7']

export type SystemPurposeId = 'AGR_high_9'|'AGR_low_3'|'AGR_low_6'|'AGR_low_7'|'AGR_low_8'|'CON_high_6'|'CON_high_7'|'CON_high_9'|'CON_low_0'|'CON_low_3'|'CON_low_5'|'EXT_high_0'|'EXT_high_2'|'EXT_high_8'|'EXT_low_0'|'EXT_low_2'|'NEU_high_8'|'NEU_low_0'|'NEU_low_1'|'NEU_low_3'|'OPE_high_9'|'OPE_low_0'|'OPE_low_4'|'OPE_low_6'|'OPE_low_7'|'Custom'
